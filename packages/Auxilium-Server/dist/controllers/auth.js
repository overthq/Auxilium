...
exports.register = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var _a, firstName, lastName, deviceId, user, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, firstName = _a.firstName, lastName = _a.lastName, deviceId = _a.deviceId;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                user = new models_1.User({ firstName: firstName, lastName: lastName, deviceId: deviceId });
                return [4, user.save()];
            case 2:
                _b.sent();
